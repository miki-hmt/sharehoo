...
<main id="tt-pageContent" class="tt-offset-small" style="padding-top:120px">
    <div class="container">
        <div class="tt-tab-wrapper">
            <div class="tt-wrapper-inner">
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link show active" data-toggle="tab" href="#tt-tab-01" role="tab"><span>关于</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-02" role="tab"><span>社区规则</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-03" role="tab"><span>FAQ</span></a>
                    </li>
                    <li class="nav-item tt-hide-xs">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-04" role="tab"><span>论坛服务</span></a>
                    </li>
                    <li class="nav-item tt-hide-md">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-05" role="tab"><span>隐私策略</span></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                <div class="tab-pane show fade active" id="tt-tab-01" role="tabpanel">
                    <div class="tt-layout-tab">
                        <div class="tt-wrapper-inner">
                            ...
                            IT资讯交流传播社区是一个由创意人士组成的社区，他们聚集在一起分享想法，互相帮助，取得成功。
                            <h3 class="tt-title">
                                管理员
                            </h3>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="#" class="tt-avatar">
                                            ...
                                            <div class="tt-col-description">
                                                <h6 class="tt-title">miki</h6>
                                                <div class="tt-value">@miki艾比利</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <a href="#" class="tt-avatar">
                                            ...
                                            <div class="tt-col-description">
                                                <h6 class="tt-title">李晓蛮</h6>
                                                <div class="tt-value">@娜乌西卡lxm</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="tab-pane" id="tt-tab-02" role="tabpanel">
                    <div class="tt-wrapper-inner tt-layout-tab">
                        ...
                        <p>IT资讯传播交流社区是一个由创意人士组成的社区，他们聚集在一起分享想法，并帮助彼此取得成功.</p>
                        <p>
                            我们邀请你加入，但是有一些规则。下面的规则和价值观有助于您理解成为社区成员的意义，并涵盖IT资讯传播交流社区论坛、博客、竞赛和活动上社区互动的所有方面。我们致力于维护他们，我们希望你们也会支持他们。
                        </p>
