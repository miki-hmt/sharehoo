...
<head>
    ...
    <link rel="stylesheet" href="${host}/bbs/css/pageHelper.css"/>
    <!--  2018.07.24 代码块样式 -->
    ...
    <style type="text/css">
        .demo1 img{ width: 23px; height: 23px; position: absolute; bottom:auto; left: calc(20% + 0); margin-left: -10px; }
        .demo2 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo3 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo4 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo5 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo6 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo7 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo8 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo9 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo10 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(20% + 0); margin-left: -10px; }
        .demo11 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo12 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo13 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo14 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo15 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo16 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo17 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo18 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo19 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px; }
        .demo20 img{ width: 23px; height: 23px; position: absolute; bottom: auto; left: calc(18% + 0); margin-left: -10px;}
...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-single-topic-list">
            <div class="tt-item">
                 <div class="tt-single-topic">
                    <div class="tt-item-header">
                        <div class="tt-item-info info-top">
                            ...
                            <a href="#" class="tt-info-time">
                                <i class="tt-icon"><svg><use xlink:href="#icon-time"></use></svg></i><fmt:formatDate value="${topic.publishTime }" pattern="yyyy-MM-dd HH:mm:ss "/>
                            </a>
                        </div>
                        ...
                        <div class="tt-item-tag">
                            <ul class="tt-list-badge">
                                <li><a href="#"><span class="tt-color03 tt-badge">百度云</span></a></li>
                                <li><a href="#"><span class="tt-badge">加速</span></a></li>
                                <li><a href="#"><span class="tt-badge">网站</span></a></li>
                            </ul>
                        </div>
                    </div>

                    <!--2020.09.05 miki 话题内容显示，"show_e"样式是用来回显表情包文件转图片的，必须要加上-->
                    <div class="tt-item-description show_e">
                        ${topic.content}
                    </div>
                    <div class="tt-item-info info-bottom">
                        ...
                        <a href="javascript:void(0);" class="tt-icon-btn tt-hover-02 tt-small-indent" onclick="firstReply()">
            ...
            <div class="tt-item">
                <div class="tt-info-box">
                    ...
                    <hr>
                    <h6 class="tt-title">话题参与者</h6>
                    <div class="tt-row-icon">
                        <c:forEach items="${activeList }" var="reply" varStatus="status">
                            <div class="tt-item">
                                <a href="#" class=" tt-icon-avatar">
                                    <img alt="" src="${host}/${reply.user.face}" style="width: 40px;height: 40px;border-radius:50%;">
                    ...
                    <div class="row-object-inline form-default">
                        <h6 class="tt-title">回复显示排序:</h6>
                        <ul class="tt-list-badge tt-size-lg">
                            <li><a href="#"><span class="tt-badge">最新</span></a></li>
                            <li><a href="#"><span class="tt-color02 tt-badge">点赞数</span></a></li>
                            <li><a href="#"><span class="tt-badge">最长</span></a></li>
                            <li><a href="#"><span class="tt-badge">最短</span></a></li>
                            <li><a href="#"><span class="tt-badge">最满意</span></a></li>
                        </ul>
                        <select class="tt-select form-control">
                            <option value="Recent">最新</option>
                            <option value="Most Liked">点赞数</option>
                            <option value="Longest">内容长</option>
                            <option value="Shortest">内容短</option>
                            <option value="Accepted Answer">最满意</option>
                        </select>
                    </div>
                </div>
            </div>

            <!--2020.09.05 miki 回复列表。。。。-->
            <c:forEach items="${replyList }" var="reply" varStatus="status">
                <div class="tt-item">
                    <div class="tt-single-topic">
                        <div class="tt-item-header pt-noborder">
                            <div class="tt-item-info info-top">
                                <div class="tt-avatar-icon">
                                    ...
                                    <i class="tt-icon"><img alt="" src="${host}/${reply.user.face}" style="width: 40px;height: 40px;border-radius:50%;"></i>
                                </div>
                                <div class="tt-avatar-title">
                                    <a href="#">${reply.user.nickName}</a>
                                </div>
                                <a href="#" class="tt-info-time">
                                    <i class="tt-icon"><svg><use xlink:href="#icon-time"></use></svg></i><fmt:formatDate value="${reply.publishTime }" pattern="yyyy-MM-dd HH:mm:ss "/>
                                </a>
                            </div>
                        </div>

                        <!--回复列表    "show_e"属性是用来处理表情包回显的，必须要加上，否则无法将文件表情转为图片     2020.09.05 miki-->
                        <div class="tt-item-description show_e">
                            ${reply.content}
                                <c:choose>
                                                    ...
                                                    <div class="topic-inner">
                                                        <div class="topic-inner-title">
                                                            <div class="topic-inner-avatar">
                                                                <i class="tt-icon"><img alt="" src="${host}/${sonReply.user.face}" style="width: 40px;height: 40px;border-radius:50%;"></i>
                                                            ...
                                                            <div class="topic-inner-title">
                                                                ...
                                                                <a href="${pageContext.request.contextPath }/blog/${sonReply.sonUser.nickNameId}" target="_blank">
                                                                    <img alt="" src="${host}/${sonReply.sonUser.face}" style="width: 27px;height: 27px;border-radius:50%;">
                                                                        ${sonReply.sonUser.nickName}
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="topic-inner-description">
                                                                ${sonReply.content}
                                                            <br>
                                                            <span style="font-size: xx-small;"><fmt:formatDate value="${sonReply.publishTime }" pattern="yyyy-MM-dd HH:mm:ss "/>
                                                                &nbsp;<a href="javascript:void(0);" onclick='replySon("${sonReply.user.nickName }","${sonReply.user.id }","${reply.id }")'>回复</a></span>
                                                        </div>
                                                    </div>
                        ...
                        <!--2020.09.05 miki 点赞功能实现-->
                        <div class="tt-item-info info-bottom">
                            <a href="javascript:void(0);" onclick='zan("${status.index+1 }","${reply.id }","${reply.good }")' class="tt-icon-btn">
                                <div class="demo${status.index+11 }"></div>
                                <i class="tt-icon"><svg><use xlink:href="#icon-like"></use></svg></i>
                                <span class="tt-text" id="gd${status.index+1}">${reply.good}</span>
                            </a>
                            <!--2020.09.05 miki 踩一踩功能实现-->
                            <a href="javascript:void(0);" onclick='bad("${status.index+1 }","${reply.id }","${reply.bad}")' class="tt-icon-btn">
                                <div class="demo${status.index+1 }"></div>
                                <i class="tt-icon"><svg><use xlink:href="#icon-dislike"></use></svg></i>
                                <span class="tt-text" id="bd${status.index+1}">${reply.bad}</span>
                            </a>
                            ...
                            <!--2020.08.16 miki 分割线-->
                            <div class="col-separator"></div>
                            <a href="javascript:void(0);" class="tt-icon-btn tt-hover-02 tt-small-indent" style="margin-top: 5px">
                                <i class="tt-icon"><svg><use xlink:href="#icon-share"></use></svg></i>
                            </a>

                            <!--2020.09.05 miki 回复功能-->
                            <a href="javascript:void(0);" onclick='replySon("${reply.user.nickName }","${reply.user.id }","${reply.id }")'
                                class="tt-icon-btn tt-hover-02 tt-small-indent" style="margin-top: 5px">
                                <i class="tt-icon">
                                    <svg t="1599322553470" class="icon" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2668" width="200" height="200">
                                        <path d="M827.713294 1024c-26.319481-17.956282-49.933221-33.944751-73.546961-49.933221-48.211386-33.206822-95.930819-67.151573-144.880135-99.128513-9.347105-6.149411-23.121787-8.3632-34.928657-8.609176-131.597406-0.737929-263.194811 0-394.792217-0.737929-89.781408-0.491953-166.03411-68.135479-178.578909-156.687005-0.983906-7.133317-0.737929-14.758588-0.737929-22.137881 0-169.231804 0.491953-338.709584-0.245976-507.941388-0.491953-91.01129 71.087197-164.066298 157.178957-176.119145 12.544799-1.721835 25.335575-2.459765 37.880375-2.459765 216.951237 0 433.656498-0.491953 650.607735 0.245976 88.797502 0.245976 166.280086 70.349267 177.349027 158.40884 0.983906 7.379294 0.491953 14.758588 0.491953 22.137881 0 168.493875-0.737929 336.987749 0.245976 505.481624 0.737929 91.995196-71.087197 165.296181-157.178957 177.103051-12.544799 1.721835-25.089599 2.459765-39.110257 3.689647C827.713294 917.73817 827.713294 969.14725 827.713294 1024zM354.700563 433.656498c0.245976-43.291857-35.174634-79.20442-78.466491-79.450396-42.307951-0.245976-78.220514 35.174634-78.712467 77.974538-0.737929 42.799904 35.42061 79.450396 78.466491 79.450396C318.542024 511.877012 354.454587 476.210425 354.700563 433.656498zM590.837964 433.902474c0.245976-43.291857-34.928657-79.20442-78.220514-79.696373-42.307951-0.245976-78.220514 34.928657-78.958443 77.974538-0.737929 42.799904 35.174634 79.450396 78.466491 79.696373C554.433448 511.877012 590.591988 476.210425 590.837964 433.902474zM826.975365 432.918568c0-43.291857-36.15854-79.20442-78.958443-78.712467-42.553927 0.245976-77.974538 36.15854-77.974538 78.712467 0 43.04588 36.404516 79.20442 79.20442 78.712467C791.800731 511.139082 826.975365 475.718472 826.975365 432.918568z" p-id="2669">
                            ...
                            <!--引用功能-->
                            <a href="javascript:void(0);" onclick='copy("<c:out value="${reply.content }" escapeXml="true"/>","${(page-1)*10+status.index+1 }")'
                               class="tt-icon-btn tt-hover-02 tt-small-indent" style="margin-top: 5px">
                                <i class="tt-icon"><svg><use xlink:href="#icon-reply"></use></svg></i>
                            </a>

                            <!--折叠标记功能，该回复踩的数量过多，版主可以将此评论标记折叠-->
            ...
            <!--回复列表demo样例  以后扩展可以参考    2020.09.06 miki-->
            <div class="tt-item">
                 <div class="tt-single-topic">
                    <div class="tt-item-header pt-noborder">
                        <div class="tt-item-info info-top">
            ...
            <div class="tt-item tt-wrapper-danger">
                 <div class="tt-single-topic">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto ml-auto">
                            <a href="#" class="btn btn-primary tt-offset-27">展示回复列表</a>
                        </div>
                    </div>
                </div>
            </div>
                       ...
                       <div class="row tt-offset-37">
                           <div class="col-lg-10">
                               <div class="tt-gallery-layout">
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img03.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img03.jpg" alt=""></a>
                                    </div>
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img04.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img04.jpg" alt=""></a>
                                    </div>
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img05.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img05.jpg" alt=""></a>
                                    </div>
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img06.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img06.jpg" alt=""></a>
                                    </div>
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img07.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img07.jpg" alt=""></a>
                                    </div>
                                    <div class="tt-item">
                                        <a href="${host}/bbs/images/single-topic-img08.jpg" class="tt-gallery-obj"><img src="${host}/bbs/images/single-topic-img08.jpg" alt=""></a>
                                    </div>
                                </div>
                           </div>
                       </div>
        ...
        <div class="tt-wrapper-inner">
            <div class="pt-editor form-default" id="replyLocation">
                <h6 class="pt-title">提交你的评论</h6>
                 <div class="pt-row">
                    <div class="col-left">
                        <ul class="pt-edit-btn">
                                        ...
                                        <!--2020.09.05 miki 请输入代码块-->
                                        <li><button type="button" class="btn-icon" id="codeBtn">
                                            <svg class="tt-icon">
                                        ...
                                        <!--2020.09.05 miki 表情包显示-->
                                        <li><button type="button" class="btn-icon" id="message_face">
                                            <svg class="tt-icon">
                ...
                <!--2020.09.05 miki 回复表单,-->
                <!--2020.09.06 miki emotionContainer,表情包显示容器，用来显示下拉表情包-->
                ...
                <form action="" method="post" id="replyForm" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <textarea id="reply" name="content" class="form-control" rows="5" placeholder="Lets get started"></textarea>
                    </div>
                    <div class="pt-row">
                        <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <font id="error"></font>
                        <a href="javascript:void(0)" id="okBtn" class="btn btn-secondary btn-width-lg">回复</a>
                    </div>
                </div>
                </form>
            </div>
                ...
                <div class="tt-search">
                    <form class="search-wrapper">
                        <div class="search-form">
                            <input type="text" class="tt-search__input" placeholder="搜索话题">
...
//            y:100
    ...
    //代码块按钮打开弹窗
    EventUtil.addEvent(EventUtil._$('codeBtn'),'click', function() {
        p.show({//定义坐标，如果缺省则居中显示
//            x:100,
//            y:100
        });
...
<script type="text/javascript">
    ...
    function zan(order,rid,num){
        ...
        if(goodLimit > 10){
            ...
            $("#"+goodx).text(num);
            $.post("${host}/reply/dianzan",{rid:rid, num: num},
                function(result){
                    if(!result.success){
                        tipError("点赞失败，请重试");
                    }
    ...
    function bad(order,rid,num){
        ...
        if(badLimit > 10){
            ...
            $("#"+badx).text(num);
            $.post("${host}/reply/cai",{rid:rid, num:num},
                function(result){
                    if(!result.success){
                        tipError("出错咯，请重试");
                    }
    ...
    function flyEmotions(order, type){
        debugger;
        var x = 100;
        var y = 900;
        var nb = Math.floor(Math.random() * 7 + 1);
        var index=$('.demo'+order).children('img').length;
        var rand = parseInt(Math.random() * (x - y + 1) + y);

        $('.demo'+order).append("<img src=''>");
        $('.demo'+order+' img:eq(' + index + ')').attr('src','${host}/topic/'+type+'/'+nb+'.gif');
        $(".demo"+order+" img").animate({
            bottom:"800px",
            opacity:"0",
            left: rand,
        },3000,function(){
    ...
    function firstReply(){
        ...
        document.getElementById('replyLocation').scrollIntoView();
    }
    ...
    //楼层回复传参功能实现      2017.02.28
    function replySon(nickName, replySonId, replyId){
        debugger
        document.getElementById("title").value = replyId;
        document.getElementById("replySonId").value = replySonId;
    ...
    $("#okBtn").on("click", function() {
        ...
        if(forbiddenStr($("#reply").val())==true){
