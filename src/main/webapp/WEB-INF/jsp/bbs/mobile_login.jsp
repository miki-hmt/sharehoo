    ...
    <div class="container">
        <div class="tt-loginpages-wrapper">
            <div class="tt-loginpages">
                <a href="${host}" class="tt-block-title">
                    <img src="${host}/common/images/logo/logo1.jpg" alt="">
                    <div class="tt-title">
                        欢迎来到sharehoo IT帮资讯交流社区
                    </div>
                    <div class="tt-description">
                        登录您的帐户以释放社区的真正力量。
                    </div>
                </a>
                <form class="form-default" method="post" action="" id="login_form">
                    <div class="form-group">
                        <label for="txtUser">账户</label>
                        <input type="text" name="nickName" class="form-control" id="txtUser" placeholder="用户名/邮箱/手机号">
                    </div>
                    <div class="form-group">
                        <label for="Userpwd">密码</label>
                        <input type="password" name="password" class="form-control" id="Userpwd" placeholder="************">
                    </div>

                    <div class="form-group">
                        <label for="txtCode">验证码</label>
                        <br/>
                        <input type="text" value="${imageCode }" id="txtCode" name="imageCode" class="form-control" style="width:60%" placeholder="验证码" />
                        <img id="randImage" src="imageCode" width="90" height="37" name="randImage" title="点击换一个"
                             style="vertical-align: middle;margin-left: 10px;" onclick="javascript:loadimage();" />
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <a href="javascript:void(0)" id="logbtn" class="btn btn-secondary btn-block">登录</a>
                    </div>
                    <p>使用社交账户登录</p>
                    <div class="row">
                        <div class="col">
                    ...
                    <p>没有账户? <a href="#" class="tt-underline">创建一个</a></p>
                    <div class="tt-notes">
                        By Logging in, signing in or continuing, I agree to
                        sharehoo’s <a href="#" class="tt-underline">Terms of Use</a> and <a href="#" class="tt-underline">Privacy Policy.</a>
                    </div>
                </form>
            </div>
        </div>
