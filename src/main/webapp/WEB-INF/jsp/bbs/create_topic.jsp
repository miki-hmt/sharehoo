...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" method="post" id="topic_form" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="inputTopicTitle">话题名称</label>
                    <div class="tt-value-wrapper">
                        <input type="text" name="title" id="title" class="form-control" id="inputTopicTitle" placeholder="话题名称">
                        <input id="user" name="user.id" value="${currentUser.id }"
                               type="hidden" />
                        <span class="tt-value-input">99</span>
                    </div>
                    <div class="tt-note">描述好你的主题，同时尽量简短。</div>
                </div>
                <div class="form-group">
                    <label>话题类型</label>
                ...
                <div class="pt-editor">
                    <h6 class="pt-title">话题内容</h6>

                    <div class="form-group">
                        <textarea name="content" id="Content" class="form-control" rows="5" placeholder="Lets get started"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="section" name="section.id">
                    ...
                    <div class="row">
                        <div class="col-auto ml-md-auto">
                            <a href="javascript:void(0)" id="okBtn" class="btn btn-secondary btn-width-lg">发布</a>
                        </div>
                    </div>
                </div>
            </form>
