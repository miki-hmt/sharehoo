            ...
            <div class="tt-innerwrapper tt-row">
                <div class="tt-col-left">
                    <ul class="tt-list-badge">
                        <li><a href="#"><span class="tt-color01 tt-badge">${section.name}</span></a></li>
                    </ul>
                </div>
                <div class="ml-left tt-col-right">
                    <div class="tt-col-item">
                        <h2 class="tt-value">话题数 - ${fn:length(section.topicList)}</h2>
                    </div>
                    <div class="tt-col-item">
                        ...
                        <div class="tt-search">
                            ...
                            <form class="search-wrapper" method="post" onsubmit="return check_up(this);">
                                <div class="search-form">
                                    <input type="text" class="tt-search__input" placeholder="Search in politics" id="search" name="keywords">
        ...
        <div class="tt-topic-list">
            ...
            <c:forEach items="${zdTopicList }" var="topic">
                <div class="tt-item tt-itemselect">
                            ...
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile">
                                        <a href="#"><span class="tt-color01 tt-badge">${section.name}</span></a></li>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li><a href="#"><span class="tt-color08 tt-badge">精华</span></a></li>
                                        </c:otherwise>
                                    </c:choose>
                                    <c:choose>
                                        <c:when test="${topic.top==1 }">
                                            <li><a href="#"><span class="tt-badge">置顶</span></a></li>
                                        </c:when>
                    ...
                    <div class="tt-col-value hide-mobile"><fmt:formatDate value="${topicLastReply.get(topic).publishTime }" pattern="yy/MM/dd HH:mm:ss "/></div>
                    <div class="tt-col-category">
                        <c:choose>
                            <c:when test="${currentUser.type==2 }">
                                <a href="javascript:void(0)" onclick="javascript:setTop(${topic.id })">
                                    <span class="tt-color04 tt-badge">精华</span>
                                </a>
                                <a href="javascript:void(0)" onclick="javascript:modifyTopic(${topic.id })">
                                    <span class="tt-color04 tt-badge">撤销</span>
                                </a>
                            </c:when>
                            <c:when test="${currentUser.id==topic.user.id&&currentUser.id!=section.master.id }">
                                <span class="tt-badge">限制操作己帖</span>
                            </c:when>
                            ...
                            <c:otherwise>
                                <font style="font-size:9pt;color:gray;">
                                    <span class="tt-badge">无权限操作</span>
                                </font>
                            </c:otherwise>
                        </c:choose>
                    </div>
            ...
            <div class="tt-item tt-itemselect">
                ...
                <div class="tt-col-category"><span class="tt-color01 tt-badge">${section.name}</span></div>
            </div>


            <!--普通帖子列表  2020.09.06 miki-->
            <c:forEach items="${ptTopicList }" var="topic" varStatus="status">
                <div class="tt-item">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="${host}/topic/detail/${topic.id}">
                            ${topic.title}
                        </a></h6>
                        <div class="row align-items-center no-gutters">
                            <div class="col-11">
                                <ul class="tt-list-badge">
                                    <li class="show-mobile"><a href="#"><span class="tt-color01 tt-badge">${section.name}</span></a></li>
                                    <li><a href="#"><span class="tt-badge">${topic.user.nickName}</span></a></li>
                    ...
                    <div class="tt-col-category">
                        <c:choose>
                            <c:when test="${currentUser.type==2 }">
                                <a href="javascript:void(0)" onclick="javascript:setTop(${topic.id })">
                                    <span class="tt-color04 tt-badge">置顶</span>
                                </a>
                                <a href="javascript:void(0)" onclick="javascript:delTopic(${topic.id })">
                                    <span class="tt-color04 tt-badge">删除</span>
                                </a>
                            </c:when>
                            <c:when test="${currentUser.id==topic.user.id&&currentUser.id!=section.master.id }">
                                <span class="tt-badge">限制操作己帖</span>
