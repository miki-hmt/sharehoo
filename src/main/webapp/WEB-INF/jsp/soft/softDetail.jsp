...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/soft/sectionDetail_files/list.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/soft/sectionDetail_files/base.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/jst.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/browser.js"></script>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/soft/sectionDetail_files/keyfile.css">
...
<script src="${pageContext.request.contextPath}/soft/sectionDetail_files/share.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/soft/sectionDetail_files/share_style0_16.css">
...
<div class="row mt10">
                    ...
                    <div class="soft-cnt mt5 clearfix">
                        <div class="soft-pic mt5 fl">
                            <div class="previewimg" rel="http://sharehoo.cn/uploadfiles/preview_img/2014/0822/water_2014082213450664116.jpg"style="width:200px;height:200px;">
                                <img src="${pageContext.request.contextPath}/${soft.logo }" style="margin:0px auto;width:200px;height:200px;">                               
                            </div>
                        </div>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2014040209154541680.png" width="48" alt="DirectX修复工具3.5(dx修复工具DirectX Repair下载)增强版"></a>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_352.png" width="48" alt="Microsoft Visual C++ 2005 SP1运行库(VC2005运行库下载)官方版"></a>
 ...
 <li>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2015060108312985976.png" width="48" alt="CPU-Z 1.78.1(CPU检测软件cpuz中文版下载) 官方中文绿色版"></a>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2013031208561653579.png" width="48" alt="Ghost(Ghost备份还原工具)12.0.0.8006官方版下载"></a>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/516.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2015052608571168780.png" width="48" alt="VMware Workstation(vmware虚拟机下载)9.0.4.1945795官方下载"></a>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/24738.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2013121115312650366.png" width="48" alt="万能驱动助理 6.0.2013.1209_WinXP官网版(XP 32位专版)"></a>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/6015.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_6015.png" width="48" alt="硬盘序列号读取器 V1.0绿色版"></a>
 ...
 <li>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/5537.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_b72c29649009dac743770805a087b198.gif" width="48" alt="Office卸载工具(解决office卸载不了)微软官方版"></a>
  ...
  <ul class="soft-top-list xtaber-item onlyhover" style="display: none;">
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/158.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2015052108450921814.png" width="48" alt="HD Tune Pro(硬盘检测工具下载)V5.60官方正式版"></a>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/120.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_120.png" width="48" alt="Windows XP SP3截至2014年5月更新补丁汇总(WinXP补丁包)"></a>
 ...
 <li>
    ...
    <div class="app-img">
        <a href="http://sharehoo.cn/html/1305.html" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2015050510075132209.png" width="48" alt="DiskGenius(硬盘分区软件下载) V4.9.2.371简体中文免费版"></a>
 ...
 <li>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2015052708381564145.png" width="48" alt="CCleaner中文版(系统垃圾清理工具)V5.22.5724绿色中文版"></a>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2013032113352664275.png" width="48" alt="驱动人生Win8预览版(驱动人生2013官网下载) V1.0.0.2官方版"></a>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_2014060609155065913.png" width="48" alt="Windows一键还原2012(一键ghost)2.0.1.23正式版"></a>
 ...
 <li>
    ...
    <div class="app-img">
        <a href="" class="pic" target="_blank"><img src="${pageContext.request.contextPath}/soft/sectionDetail_files/thumb_48_48_b72c29649009dac743770805a087b198.gif" width="48" alt="Office卸载工具(解决office卸载不了)微软官方版"></a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/xzb_haha.js"></script>  
</div>

<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/common.js"></script>
<div style="display:none">
<script type="text/javascript" src="${pageContext.request.contextPath}/soft/sectionDetail_files/stat.js"></script>
