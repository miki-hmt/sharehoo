							...
							<tbody>
								<c:forEach items="${unReplyList }" var="reply" varStatus="state">
									<tr>	
										...
										<td style="text-align: center;vertical-align: middle;font-size:10pt;"><a href="Reply_update.action?replyId=${reply.id }">标为已读</a></td>
    ...
    <div id="right_1">
	    ...
	    <li><a href="User_userCenter.action"><span style="font-size:9pt;">回到首页</span></a></li>          
            ...
            <li><a href="User_answer.action"><span style="font-size:9pt;">我的提问</span></a></li>
             <li><a href="User_unReply.action"><span style="font-size:9pt;font-weight:bold;color:yellow;">信箱(<font style="font-size:9pt;color:yellow;">${count}</font>)</span></a></li>
