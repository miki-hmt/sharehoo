			...
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title">
						...
						<h5>发帖历史记录：<font style="font-size:8pt;color:red;">共${count1}条</font></h5>
					</div>
									...
									<tr>																			
										...
										<td style="text-align: center;vertical-align: middle;font-size:10pt;">
											<strong>${topicLastReply.get(topic).user.nickName }</strong>
												<fmt:formatDate value="${topicLastReply.get(topic).publishTime }" pattern="yyyy-MM-dd HH:mm:ss "/></td>
										</td>
...
<div id="main">
    ...
    <div id="right_1">
	    ...
	    <li><a href="${host}/user/center?page=1"><span style="font-size:9pt;">回到首页</span></a></li>     
            <li><a href="${host}/user/topic?page=1"><span style="font-size:9pt;color:yellow;font-weight:bold;">我的帖子</span></a></li>
