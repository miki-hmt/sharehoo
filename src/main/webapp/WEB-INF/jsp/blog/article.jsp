...
<div class="ibody">
  ...
  <aside>
    <div class="rnav">
      <li class="rnav1 "><a href="${host}/blog/${user.nickNameId}/article/category/日记">日记</a></li>
      <li class="rnav2 "><a href="${host}/blog/${user.nickNameId}/article/category/编程">编程</a></li>
      <li class="rnav3 "><a href="${host}/blog/${user.nickNameId}/article/category/经典语录">经典语录</a></li>
