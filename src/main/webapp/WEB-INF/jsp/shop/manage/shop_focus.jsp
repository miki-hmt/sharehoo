          ...
          <div class="datas_detail pull-left">
            <ul class="tabs clearfix">
             ...
             <li><a href="${pageContext.request.contextPath}/shop/admin/log">虎豆明细</a></li>     
              ...
              <li class="cur"><a href="${pageContext.request.contextPath}/shop/admin/focus">我的关注</a></li>     
				...
				<div class="card clearfix">
					...
					<img src="${pageContext.request.contextPath}/shop/${focus.shop.face}"></a>
						...
						<div class="content">
							...
							<div class="score">
								<label>所需虎豆：</label>${good.get(focus).douNum }					
							</div>
							
							<div class="flag">
             					<a href="javascript:void(0);" onclick="cancel_fav('${focus.shop.shop_name }','${focus.shop.id}')">取消关注</a>
             				</div>
...
<script type="text/javascript">
function cancel_fav(shopname,shopId)
{
	//$.confirm("<p>您确定要退出sharehoo社区</p><p>一个人浪迹天涯吗？</P>");
	swal({
		title : "您确定要取消对"+shopname+"的关注吗？",
		...
		$.post("${host}/shop/cancelFocus", {
			shopId:shopId
		}, function(result) {
			if (result.status == 200) {
				tipOk("取消关注成功",function(){
