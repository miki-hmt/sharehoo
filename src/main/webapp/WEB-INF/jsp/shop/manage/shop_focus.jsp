          ...
          <div class="datas_detail pull-left">
            <ul class="tabs clearfix">
             ...
             <li><a href="${pageContext.request.contextPath}/shop/manage/ShopManage_operatelog.action">虎豆明细</a></li>     
              ...
              <li class="cur"><a href="${pageContext.request.contextPath}/shop/manage/ShopManage_focus.action">我的关注</a></li>     
...
{
	var b=shopname;
	if(confirm("您确定要取消对"+b+"的关注吗？"))
	{

		$.post("Operate_cancelFocus.action",{shopId:shopId},
				function(result){
	    			if(result.success){
	    				alert("取消成功！");
