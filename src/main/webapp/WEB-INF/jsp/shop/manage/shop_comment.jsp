        ...
        <div class="main">
          <div class="datas_detail pull-left">
            <ul class="tabs clearfix">
              ...
              <li class="cur"><a href="${pageContext.request.contextPath}/shop/manage/ShopManage_comment.action">店铺评价</a></li>
            ...
            <div class="items">
                         ...
                         <!--上传资源页面  -->                                                     
              <!--上传资源页面  -->                                                     
              <div class="item score_detail">
              <ul>
              	 <li>
	           	<div class="card">
	              <div class="score">好评/总评价数</div>
	              <div class="date">好评率</div>
	              <div class="from">店铺等级</div>
	              <div style="margin-left:230px;">站长寄语</div>
	           </div>
              </li>
	              ...
	              <li>
		              <div class="card">
		                 ...
		                 <div class="score"><font style="font-size:9pt;color:red;">${goodComment}</font>/<font style="font-size:9pt;">${totalComment }</font></div>	
		                 <div class="date">
		                 <a href='#'></a><font style="font-size:9pt;">${percent }</font>                
		                 </div>
		                 
		                 <c:choose>
			              	<c:when test="${shop.douNum<50 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/qingTong.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">青铜小菜鸡</font>
			              		</div>
			              	</c:when>
			              	<c:when test="${shop.douNum>49 && shop.douNum<100 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/baiyin.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">白银小胸弟</font>
			              		</div>
			              	</c:when>
			              	
			              	<c:when test="${shop.douNum>99 && shop.douNum<150 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/huangjin.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">黄金小搭档</font>
			              		</div>
			              	</c:when>
			              	<c:when test="${shop.douNum>149 && shop.douNum<200 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/baijin.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">白金大胸弟</font>
			              		</div>
			              	</c:when>
			              	<c:when test="${shop.douNum>199 && shop.douNum<300 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/zuanshi.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">钻石当家</font>
			              		</div>
			              	</c:when>
			              	<c:when test="${shop.douNum>299 && shop.douNum<400}">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/chaofan.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">超凡大师</font>
			              		</div>
			              	</c:when>
			              	<c:when test="${shop.douNum>399 }">
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/wangzhe.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">最强王者</font>
			              		</div>
			              	</c:when>
			              	<c:otherwise>
			              		<div class="type"><img src="${pageContext.request.contextPath }/shop/images/level/qingTong.jpg" style="width:50px;border:1px solid gray;">
			              			<font style="font-size:12pt;color:red;">辣鸡塑料</font>
			              		</div>		              	
			              	</c:otherwise>
		                 </c:choose>
		                 		                	                                  
		                 <c:choose>
			              	<c:when test="${percent<0.5 }">
			              		<div style="margin-left:660px;position:absolute;">
		                 		<font style="font-size:9pt;">大胸弟，胜率有点低啊，做人要实在，不能坑蒙拐骗</font>
		                 		</div>
			              	</c:when>
			              	<c:when test="${percent>0.5 && percent<0.8 }">
			              		<div style="margin-left:660px;position:absolute;">
		                 		<font style="font-size:9pt;">革命尚未完成，同志仍需努力啊</font>
		                 		</div>
			              	</c:when>
			              	<c:otherwise>
			              		<div style="margin-left:660px;position:absolute;">
		                 		<font style="font-size:9pt;">厉害了，我的哥,吃鲸<br></font>
		                 		</div>		              	
			              	</c:otherwise>
		              	</c:choose>		              	
		              </div>
