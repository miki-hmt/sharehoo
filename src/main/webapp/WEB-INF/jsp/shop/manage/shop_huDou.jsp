          ...
          <div class="datas_detail pull-left">
            ...
            <div class="items">
              ...
              <ul>
              	 <li>
	           	<div class="card">
	              <div class="score">虎豆失踪/增加</div>
	              <div class="date">时间</div>
	              <div class="from">虎豆生死之谜</div>
	              <div style="margin-left:230px;">凶手</div>
	           </div>
              </li>
             <c:forEach  items="${operateList}" var="operate">          
	              <li>
		              <div class="card">
		              <c:choose>
		              	<c:when test="${operate.type=='download' }">
		              		<div class="score"><font style="font-size:16pt;color:red;">-${operate.source.douNum }</font></div>
		              	</c:when>
		              	<c:when test="${operate.user.id==currentUser.id }">
		              		<div class="score"><font style="font-size:16pt;color:red;">-0</font></div>
		              	</c:when>
		              	<c:otherwise>
		              		<div class="score"><font style="font-size:16pt;color:red;">+${operate.source.douNum }</font></div>
		              	</c:otherwise>
		              	</c:choose>	              
		                 <div class="date"><font style="font-size:9pt;"><fmt:formatDate value="${operate.operate_time }" pattern="yyyy-MM-dd HH:mm "/></font></div>	
		                 <div class="type">
		                 <a href='#'></a> -<font style="font-size:9pt;">${operate.notice }</font>                
		                 </div>
		                 <div style="margin-left:680px;position:absolute;">
		                 	<img alt="等级：1" src="${pageContext.request.contextPath}/${operate.user.face}" style="width:25px;border-radius:50%;"><font style="font-size:9pt;">${operate.user.nickName }</font>
		                 </div>
		              </div>
	              </li>                             
			</c:forEach>
