...
<title>后台管理系统模板-bootstrap中文 www.bootstrapmb.com</title>
...
<script type="text/javascript" src="${host}/new/js/jquery.min.js"></script>

<!--图表插件-->
<script type="text/javascript" src="${host}/new/js/Chart.js"></script>
