...
<div class="container-fluid">
		<div id="tooBar" style="padding: 10px 0px 0px 10px;">
					...
					<form class="form-horizontal" style="margin-top: 10px;" action="Soft_save1.action" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
					
					
					<div class="control-group">
						<label class="control-label" for="softId">【软件id】</label>
						<div class="controls">
							<input readonly="readonly" type="text" id="softId" name="soft.id" value="${soft.id}" style="width: 800px;"><span class="pull-left"></span>
						</div>
					</div>
					...
					<input type="hidden" id="publishDate" name="soft.publishDate" value="${soft.publishDate}" style="width: 800px;">
					...
					<div class="control-group">
						<label class="control-label" for="good">【是否推荐】</label>
						<div class="controls">
							<input type="text" id="good" name="soft.good" value="${soft.good }" style="width: 800px;"><span class="pull-left"></span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="hot">【是否热门】</label>
						<div class="controls">
							<input type="text" id="hot" name="soft.hot" value="${soft.hot }" style="width: 800px;"><span class="pull-left"></span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="count">【下载量】</label>
						<div class="controls">
							<input type="text" id="count" name="soft.count" value="${soft.count }" style="width: 800px;"><span class="pull-left"></span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea  id="Content" name="soft.description" class="ckeditor" cols="50" style="height:200px;width: 800px;" >
							${soft.description }
							</textarea><span class="pull-left"></span>
						</div>
					</div>
