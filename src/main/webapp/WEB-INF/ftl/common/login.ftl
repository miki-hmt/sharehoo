...
<head>
	...
	<link href="shop/css/quake.slider.css" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="font-awesome-4.4.0/css/font-awesome.min.css">
	<script src="shop/js/jquery.min.js" type="text/javascript"></script>
	<script src="shop/js/quake.slider-min.js" type="text/javascript"></script>
	<link rel="stylesheet" href="shop/css/download_index.css">
	<script src="shop/js/animateBackground-plugin.js" type="text/javascript"></script>
	<script type="text/javascript" src="shop/js/tabSwitch.js" defer></script>
	<script src="shop/js/html5shiv.min.js"></script>
	<script type="text/javascript" src="shop/js/placeholder.js"></script>
	<script language="javascript" type="text/javascript" src="shop/js/async_new.js"></script>
 ...
 <body>
  <div class="csdn-toolbar csdn-toolbar-skin-black ">
          <div class="container row center-block ">  
               		   ...
               		   <div class="icon on-ugc-icon">                 
               		     <div class="wrap clearfix">                   
	               		  ...
	               		  <dl>                      
	               		    ...
	               		    <dt>
	               		       <a href="http://sharehoo.cn/blog/manage/Article_add.action?userId=${vistor.id }" target="_blank" class="p-blog clearfix">
	               		          <em class="icon"></em>
	               		          <span>写博客</span>
	               		        </a>
	               		   </dt>                      
	               		   ...
	               		   <dt>
	               		      <a href="http://sharehoo.cn/Topic_preSave.action?sectionId=20" target="_blank" class="c-code clearfix">
	               		         <em class="icon"></em>
	               		         <span>创建代码片</span>
	               		      </a>
	               		  </dt> 
		   ...
		   <li class="profile">                
              <div class="icon on-profile-icon"><img src="${pageContext.request.contextPath }/${vistor.face}" class="curr-icon-img">                  
               	<div class="wrap clearfix">                    
               		<div class="curr-icon-wrap">                      
               		    <div class="curr-icon">
               			</div>                    
               		...
               		<dl class="clearfix">                        
               		  <dt class="pull-left img">
               		  		<a target="_blank" href="${pageContext.request.contextPath }/User_userCenter.action" class="avatar">
               		        	<img src="${pageContext.request.contextPath }/${vistor.face}" style="width:100px;height:100px;">
               		       </a>
               		  </dt>                        
               		  <dd class="info" style="border: none;"><a target="_blank" href="#" class="nickname">${vistor.nickName }
               		      </a>
