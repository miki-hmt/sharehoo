...
<link href="http://sharehoo.cn/css/style3.css" rel="stylesheet" type="text/css" />
<link href="http://sharehoo.cn/shop/images/logo/favicon.ico" rel="SHORTCUT ICON" />
<script type="text/javascript" src="http://sharehoo.cn/js/jquery-1.7.2.min.js"></script>

<!--2018.07.18  miki  ckeditor代码高亮	开头这里的样式为默认的风格，可以根据自己的喜好更换风格-->
		<!--我的高亮效果是zenburn-->
<link rel="stylesheet" href="http://sharehoo.cn/highlight/styles/zenburn.css">
<script src="http://sharehoo.cn/highlight/highlight.pack.js"></script>
<script>hljs.initHighlightingOnLoad();</script>

<link rel="stylesheet" href="http://sharehoo.cn/shop/css/search_index.css">
<link rel="stylesheet" href="http://sharehoo.cn/common/css/common.css">
<link rel="stylesheet" href="http://sharehoo.cn/common/css/download_index.css">

<link href="http://sharehoo.cn/bootstrap/css/bootstrap.css" rel="stylesheet" />
<link href="http://sharehoo.cn/bootstrap/css/bootstrap-responsive.css" rel="stylesheet" />
...
<link href="http://sharehoo.cn/css/style.css" rel="stylesheet" />
...
<div class="wrap">
	...
	<div class="header">
			<div class="header-con">
				<a class="header-logo" href="#"><img src="http://sharehoo.cn/common/images/logo/logo1.jpg" style="width:40px;height:40px;"><font style="color:white;"></font></a>
				<!-- <a href="login">登录</a>| -->
		...
		<div class="news-nav">
			<div class="container clearfix">
				<div class="nav-bar">
					<a href="http://sharehoo.cn/home" class="current">首页</a>
					<a href="http://blog.sharehoo.cn" target="_blank">博客社区<img src="http://sharehoo.cn/images/icon/hot.gif"></a>
					<a class=" " href="http://sharehoo.cn/shop/index.htm" target="_blank">下载社区<img src="http://sharehoo.cn/images/icon/hot.gif"></a>
					<a class=" " href="http://sharehoo.cn/source/W3CSchool/www.w3school.com.cn/index.html" target="_blank">W3C文档</a>
					<a href="http://sharehoo.cn/topic/section/3" target="_blank">社友圈<img src="http://sharehoo.cn/images/icon/hot.gif"></a>			
					<a class=" " href="http://sharehoo.cn/h5" target="_blank">H5小游戏</a>			
					<a href="http://sharehoo.cn/secret" target="_blank">秘密墙<img src="http://sharehoo.cn/images/icon/hot.gif"></a>
					<a href="http://sharehoo.cn/softsection/list" target="_blank">软件下载</a>
    ...
    <div class="home_page_wrap">    	
	    	<div class="home_banner">       
					...
					<h5>-<img src="http://sharehoo.cn/common/images/write.png"><a href="#1">参与讨论....</a></h5>
					</div>
				...
				<table style="width: 100%;border:1px solid silver; background-color:#EFF4FB;" cellpadding="5px;">
					...
					<tr>
						<td>
							...
							<img alt="" src="http://sharehoo.cn/${user.face}" style="width: 100px;height: 100px;border-radius:50%;">
	...
	<div class="popPanel">
		<div class="popPanel-inner">
			<div class="qrcodePanel">
				<img src="http://sharehoo.cn/images/miki.png" /><span>扫描二维码关注网站最新动态</span></div>
